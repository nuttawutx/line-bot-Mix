...
def register_employee(event, line_bot_api, spreadsheet_name, webhook_env_var, default_code, prefix=""):
    ...
    try:
        ...
        worksheet = client.open(spreadsheet_name).worksheet("MonthlyEmployee" if emp_type == "รายเดือน" else "MonthlyEmployeeWHLG" if emp_type == "รายเดือน1" else "DailyEmployee")
